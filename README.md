...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/nHBiIBKQgv)
...
```sh
npx nx serve express-bk
```

To create a production bundle:

```sh
npx nx build express-bk
```

To see all available targets to run for a project, run:

```sh
npx nx show project express-bk
```
